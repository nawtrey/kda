...
latex_documents = [
    (master_doc, 'kda.tex', 'Kinetic Diagram Analysis Documentation',
     'kda', 'manual'),
]
...
man_pages = [
    (master_doc, 'kda', 'Kinetic Diagram Analysis Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'kda', 'Kinetic Diagram Analysis Documentation',
     author, 'kda', 'Python package used for the analysis of biochemical kinetic diagrams.',
     'Miscellaneous'),
]
